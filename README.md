<body>
    <nav>
        <p><img src="https://img.shields.io/badge/STATUS%20DA%20SPRINT-FINALIZADA-sucess"></p>
        <p id="topo"><h1>iTruck :articulated_lorry:</h1></p>
        <p>Seja bem-vindo a Sprint 2 do iTruck!</p>
        <p><h2>Índice</h2></p>
        <ul>
            <li><a href="#objetivo">Objetivo da Sprint</a></li>
            <li><a href="#cads">Card da Sprint</a></li>
            <li><a href="#user_stories">User Stories da Sprint</a></li>
            <li><a href="#burndown">BurnDown da Sprint</a></li>
        </ul>
    </nav>
        <section>
            <p><h2 id="objetivo">Objetivo da Sprint :scroll:</h2></p>
            <p align="justify">O objetivo principal da Sprint é apresentar para o cliente alguns CRUDS chaves para o sistema. Portanto priorizamos a
            entrega do CRUD de funcionários e Veículos, começando por cadastrar (que já havia sido feito na sprint anterior) e passando por visualizar,
            atualizar e deletar dados. Uma vez feito esses Cruds, o restante se torna mais fácil por conta da curva de aprendizagem ja estar mais
            consolidada.</p>
            <p><a href="#topo">Voltar ao Topo</a></p>
        </section>
        <section>
            <p><h2 id="cards">Card das Sprint :bookmark: </h2></p>
            <p><h3>Sprint 02</h3></p>
        ...
        <section>
            <p><h2 id="user_stories"> User Stories da Sprint :runner: </h2></p>
            <p><h3> Sprint 02 </h3></p>
